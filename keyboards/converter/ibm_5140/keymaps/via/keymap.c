...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_PAUS, KC_SCRL, KC_INS,  KC_DEL,
        ...
        KC_LCTL,                   KC_LALT,                KC_SPC,            KC_LALT,                                        KC_UP,
                      MO(_FN1),                                                                                    KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_FN1] = LAYOUT(
        ...
        _______,                   _______,                 MO(_FN2),          _______,                                      _______,
